...
<body>
    ...
    <div class="page-wrapper">
                            ...
                            <td style="padding-top: 5px; padding-bottom: 10px;">
                                <div class="row" style="padding-right: 0; padding-left: 0;">
                                    <button type="button" class="btn btn-success mt-1 text-center  text-white"
                                        data-bs-toggle="modal" data-bs-target="#Detail<?= $row['idDaftar']; ?>"><i
                                            class="mdi mdi-eye"></i> Lihat</button>
                                </div>
                                <div class="row" style="padding-right: 0; padding-left: 0;">
                                    <button type="button" class="btn btn-danger mt-1 text-white text-center"
                                        data-bs-toggle="modal" data-bs-target="#Delete<?= $row['idDaftar']; ?>"> <i
        ...
        <?php foreach ($lowongan as $row) : ?>
        <!-- Modal Delete -->
        <div class="modal fade " id="Delete<?= $row['idDaftar']; ?>" tabindex="-1" aria-labelledby="DeleteLabel"
            aria-hidden="true">
        ...
        <!-- Modal Detail -->
        <div class="modal fade " id="Detail<?= $row['idDaftar']; ?>" tabindex="-1" aria-labelledby="DetailLabel"
            aria-hidden="true">
