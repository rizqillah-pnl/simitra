                ...
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item" style="background-color: #1a9bfc; border-radius: 9px"> <a
                            ...
                            aria-expanded="false"><i class="mdi mdi-worker text-white"></i><span
                                class="hide-menu text-white">Lowongan Terdaftar</span></a></li>
        ...
        <div class="container-fluid">
            <div class="table-responsive" id="container">
                <table class="table table-hover align-middle text-nowrap table-striped">
                    ...
                    <?php $no = $awalData; ?>
                    <tbody>
                        <?php $lowongan = mysqli_query($conn, "SELECT tb_lowongan_user.id, tb_lowongan_user.id_lowongan, tb_lowongan_user.id_petugas, tb_lowongan_user.tanggal_daftar, tb_lowongan_user.id_kec, lowongan.jenis_lowongan, lowongan.tanggal_mulai, lowongan.tanggal_akhir, lowongan.persyaratan, lowongan.deskripsi, lowongan.gambar, tb_kecamatan.nama_kec FROM tb_lowongan_user LEFT JOIN lowongan ON lowongan.id=tb_lowongan_user.id_lowongan LEFT JOIN tb_kecamatan ON tb_kecamatan.id=tb_lowongan_user.id_kec WHERE tb_lowongan_user.id_petugas='$kode' ORDER BY tb_lowongan_user.id DESC LIMIT $awalData, $jumlahDataPerHalaman"); ?>
