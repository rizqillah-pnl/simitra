...
<head>
    <title>Lowongan Terdaftar | Simitra Aceh Utara</title>
        ...
        <div class="container-fluid">
            <div class="table-responsive" id="container">
                <table class="table table-hover align-middle text-nowrap table-striped">
                    ...
                    <?php $no = $awalData; ?>
                    <tbody>
                        <?php $lowongan = mysqli_query($conn, "SELECT tb_lowongan_user.id, tb_lowongan_user.id_lowongan, tb_lowongan_user.id_petugas, tb_lowongan_user.tanggal_daftar, lowongan.jenis_lowongan, lowongan.tanggal_mulai, lowongan.tanggal_akhir, lowongan.persyaratan, lowongan.deskripsi, lowongan.gambar FROM tb_lowongan_user LEFT JOIN lowongan ON lowongan.id=tb_lowongan_user.id_lowongan WHERE tb_lowongan_user.id_petugas='$kode' ORDER BY tb_lowongan_user.id DESC LIMIT $awalData, $jumlahDataPerHalaman"); ?>
                                ...
                                <tr class="text-start">
                                    ...
                                    <td style="padding-top: 5px; padding-bottom: 10px;">
                                        <div class="row" style="padding-right: 0; padding-left: 0;">
                                            <button type="button" class="btn btn-success mt-1 text-center  text-white" data-bs-toggle="modal" data-bs-target="#Detail<?= $row['id']; ?>"><i class="mdi mdi-eye"></i> Lihat</button>
                                        </div>
                                        <div class="row" style="padding-right: 0; padding-left: 0;">
                                            <button type="button" class="btn btn-danger mt-1 text-white text-center" data-bs-toggle="modal" data-bs-target="#Delete<?= $row['id']; ?>"> <i class="mdi mdi-account-remove"></i> Hapus</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
                            <td class="text-center text-secondary fw-bold" colspan="6">
                                ...
                                <p style="font-size: 15px;">Belum Mendaftar Lowongan! <a href="index.php">Daftar Disini</a>
                                </p>
                            </td>
                        <?php endif; ?>
                    </tbody>
