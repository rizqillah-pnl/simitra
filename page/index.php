                                                            ...
                                                            <div class="mb-3 row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <select name="select_box" class="form-select"
                                                                        ...
                                                                        <?php 
                                                                        $kecamatan = "SELECT nama_kec FROM kecamatan ORDER BY id_kec ASC";
                                                                        $r = $conn->query($kecamatan);
                                                                        foreach ($r as $rkec) {
                                                                            echo '<option value="'.$rkec["nama_kec"].'">'.$rkec["nama_kec"].'</option>';
                                                                        }
                                                                        ?>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="col">
                                                                    <select class="form-select"
                                                                        ...
                                                                        name="kecamatan"
                                                                        aria-label="Default select example">
                                                                        <option selected><?= $nama_kec['id_kec']; ?>
                                                                        </option>
                                                                        <?php foreach ($role as $nama_kec) :  ?>
                                                                        <?php if ($nama_kec->name != $nama_kec['id_kec']) : ?>
                                                                        <option value="<?= $nama_kec->id_kec; ?>">
                                                                            <?= $nama_kec->name; ?></option>
                                                                        <?php endif ?>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                </div> -->
