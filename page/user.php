        ...
        <div class="scroll-sidebar" id="navbar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item""> <a class=" sidebar-link waves-effect waves-dark sidebar-link"
                        href="message.php" aria-expanded="false"><i class="mdi mdi-comment-text"></i><span
                            class="hide-menu">Message Room</span></a></li>


                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                            href="maps.php" aria-expanded="false"><i class="mdi mdi-google-maps"></i><span
                                class="hide-menu">MAPS</span></a></li>

                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                            href="bangunan.php" aria-expanded="false"><i class="mdi mdi-home-map-marker"></i><span
                                class="hide-menu">Daftar Bangunan</span></a></li>
                ...
                <table class="table table-hover align-middle text-nowrap table-striped">
                    ...
                    <tbody>
                        ...
                        <tr class="text-start">
                            ...
                            <td class="text-center text-dark text-opacity-0 text-wrap text-break"
                                style="padding-bottom: 0; padding-top: 0; width: 10rem">
                                <?= $row['Last_login']; ?>
                            </td>
                            <td class="text-center text-dark " style="padding-bottom: 0; padding-top: 0;">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table table-striped-columns">
                            ...
                            <tr>
                                ...
                                <td style="padding-bottom: 0;">
                                    <?= ($row['Status'] == 1) ? "<p class='text-success'>Online</p>" : "<p class='text-muted'>Oflline</p>"; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>
