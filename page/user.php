...
$insert = mysqli_query($conn, "UPDATE auth SET Last_login='$now', Status=1 WHERE Kode_petugas='$kode'");
...
if ($result1['Id_jabatan'] == "1" || $result1['Id_jabatan'] == "2") :
...
?>
    ...
    <body>
        ...
        <div class="page-wrapper">
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($data)) : ?>
                                <tr class="text-start">
                                    ...
                                    <td class="text-center text-dark text-opacity-0 text-wrap text-break" style="padding-bottom: 0; padding-top: 0; width: 10rem">
                                        <?= $row['Last_login']; ?>
                                    </td>
                                    <td class="text-center text-dark " style="padding-bottom: 0; padding-top: 0;">
            ...
            <?php $data2 = mysqli_query($conn, "SELECT a.Kode_petugas, a.Username, a.Email, a.Password, a.Old_password, a.Last_login, a.Status, a.Created_at, a.Updated_at, b.Nama, b.NIK, b.Alamat, b.Foto, b.NoHP, b.Tanggal_lahir, b.Tempat_lahir, c.Jabatan, c.Id_jabatan FROM auth a, petugas b, jabatan c WHERE a.Kode_petugas=b.Kode_petugas AND b.Jabatan=c.Id_jabatan ORDER BY c.Id_jabatan"); ?>
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table table-striped-columns">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-bottom: 0;"><?= ($row['Status'] == 1) ? "<p class='text-success'>Online</p>" : "<p class='text-muted'>Oflline</p>"; ?></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Terakhir Update
                                        ...
                                        <select class="form-select" name="jabatan" aria-label="Default select example">
                                            <?php foreach ($q as $row) : ?>
                                                <?php if ($_SESSION['Id_jabatan'] == "1") : ?>
                                                    ...
                                                    <?php continue; ?>
                                                <?php elseif ($row['Id_jabatan'] == "1" || $row['Id_jabatan'] == "2" && $result1['Id_jabatan'] == "2") : ?>
                                                    <?php continue; ?>
                                                <?php endif; ?>
                                                <option value="<?= $row['Id_jabatan']; ?>"><?= $row['Jabatan']; ?></option>
                                            <?php endforeach; ?>
